...
class _SfDateRangePickerState extends State<_SfDateRangePicker>
  ...
  void didChangeDependencies() {
    ...
    _datePickerTheme =
        _getPickerThemeData(SfDateRangePickerTheme.of(context), Theme.of(context).colorScheme);
  ...
  SfDateRangePickerThemeData _getPickerThemeData(
    ...
    return pickerTheme.copyWith(
        ...
        viewHeaderTextStyle: pickerTheme.viewHeaderTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.87), fontSize: 14, fontFamily: 'Roboto'),
        headerTextStyle: pickerTheme.headerTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.87), fontSize: 16, fontFamily: 'Roboto'),
        trailingDatesTextStyle: pickerTheme.trailingDatesTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        leadingCellTextStyle: pickerTheme.leadingCellTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        activeDatesTextStyle: pickerTheme.activeDatesTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        ...
        disabledDatesTextStyle: pickerTheme.disabledDatesTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.38), fontSize: 13, fontFamily: 'Roboto'),
  ...
  Widget _getScrollViewItem(
    ...
    if (isHorizontal) {
      ...
      headerWidth = _getTextWidgetWidth(headerText, widget.headerHeight, pickerWidth, context,
              style: widget.headerStyle.textStyle ?? _datePickerTheme.headerTextStyle!,
              widthPadding: 20)
          .width;
    }
  ...
  Widget _getActionsButton(double top, double actionButtonsHeight) {
    ...
    if (textColor == Colors.transparent) {
      final TextStyle style =
          widget.monthCellStyle.todayTextStyle as TextStyle? ?? _datePickerTheme.todayTextStyle!;
...
class _PickerHeaderViewState extends State<_PickerHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    Color arrowColor =
        widget.headerStyle.textStyle != null && widget.headerStyle.textStyle!.color != null
    ...
    double arrowSizeIc = 35;
    final Container leftArrow = showNavigationArrow
        ? _getLeftArrow(arrowWidth, arrowColor, prevArrowColor, arrowSizeIc)
        : Container();

    final Container rightArrow = showNavigationArrow
        ? _getRightArrow(arrowWidth, arrowColor, nextArrowColor, arrowSizeIc)
        : Container();
        ...
        case DateRangePickerNavigationDirection.horizontal:
          {
            ...
            if (xPosition > width / 2 &&
                xPosition < (width / 2) + widget.picker.viewSpacing + weekNumberPanelWidth) {
              return index;
            } else if (xPosition > width / 2) {
