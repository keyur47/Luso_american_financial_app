  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:  Stack(
        ...
        children: [
          Image.asset(AssetsPath.splashScreen,fit: BoxFit.cover,height: SizeUtils.verticalBlockSize * 100,width: SizeUtils.horizontalBlockSize * 100,),
          Positioned(
              bottom: SizeUtils.horizontalBlockSize * 10,
              child:  AppText(text: StringsUtils.splashScreenText,color: AppColors.white,fontSize: SizeUtils.fSize_17(),letterSpacing: 1.6,)),
          Column(
