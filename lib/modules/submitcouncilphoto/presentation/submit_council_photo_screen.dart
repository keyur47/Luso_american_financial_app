                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => createButton(
                                      ...
                                      text: submitCouncilScreenController.isRegisterLoading.value ? 'Loading..' : "SUBMIT",
                                      onTap: () async {
                                        if (submitCouncilScreenController.tAddTournamentLogo.value.isNotEmpty) {
                                          // AppToast.toastMessage("success");
                                          await submitCouncilScreenController.submitCouncilUpload(
                                            fileUpload: submitCouncilScreenController.tAddTournamentLogo.value,
                                          );
